...
void SetSystemFrequency(CpuClockEnum freq);
...
CpuClockEnum cpuClock;	//system clock setting
 ...
 *
 * Parameters: CpuClockEnum cpu_freq
 *
 * Returns: None
 *
 * Special Notes:
 *
 *******************************************************************************************/
void InitSystemClock(CpuClockEnum cpu_freq)
{
...
void SetPeripheralClocks(void)
{
	...
	SysCtrlRegs.PCLKCR3.bit.CPUTIMER2ENCLK = 1;	// SYSCLKOUT to CPU Timer2 disabled
	SysCtrlRegs.PCLKCR3.bit.CPUTIMER1ENCLK = 1;	// SYSCLKOUT to CPU Timer1 disabled
	SysCtrlRegs.PCLKCR3.bit.CPUTIMER0ENCLK = 1;	// SYSCLKOUT to CPU Timer0 disabled
 ...
 * Parameters: None
 *
 * Returns: CpuClockEnum
 *
 * Special Notes:
 *
 *******************************************************************************************/
CpuClockEnum GetSystemFrequency(void)
{
	return cpuClock;
}
